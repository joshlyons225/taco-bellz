...
const Home = () => {
  return (
    <section name='home' className='w-full h-auto bg-violet-400'>
      ...
      <div class='bg-pink-600 py-4 px-4'>
        ...
        <button class='bg-pink-300 hover:bg-pink-100 text-black font-bold py-2 px-4 rounded'>
          UPVOTE
        </button>
        ...
        <div className='max-w-sm mx-auto flex p-6 m-5 bg-white rounded-lg shadow-xl'>
          <div className='flex shrink 0'>
            <img src={Tacoz} alt='glory taco' class='h-12 w-12'></img>
          </div>
